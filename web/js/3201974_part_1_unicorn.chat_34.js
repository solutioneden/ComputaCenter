...
$(document).ready(function(){
	...
	$('.chat-message button').click(function(){
		...
		if(input.val() != ''){
			add_message('You','/web/bundles/chatterbox/images/demo/av1.jpg',input.val(),true);
		}		
	});
	...
	$('.chat-message input').keypress(function(e){
		if(e.which == 13) {	
			if($(this).val() != ''){
				add_message('You','/web/bundles/chatterbox/images/demo/av1.jpg',$(this).val(),true);
			}		
		}
	});
	
	setTimeout(function(){
			add_message('Neytiri','/web/bundles/chatterbox/images/demo/av2.jpg','I have a problem. My computer not work!')
		},'6000');
	setTimeout(function(){
			add_message('Cartoon Man','/web/bundles/chatterbox/images/demo/av3.jpg','Turn off and turn on your computer then see result.')
		},'11000');
	setTimeout(function(){
